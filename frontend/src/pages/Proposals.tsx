...
const INITIAL_PROPOSALS: ProposalItem[] = [
  {
    ...
    title: 'Department Function Expenses',
    category: 'Expense',
    ...
    priority: 'High',
    status: 'PENDING',
    dateRangeOrScope: 'Annual Day Celebration Budget ($2,500)',
    reason: 'Funding request for catering and decor setup for the annual employee appreciation evening function.',
    attachmentName: 'Appreciation_Budget_Proposal.pdf',
    attachmentSize: '3.4 MB',
    aiPoints: [
      'Remaining annual department budget is $8,200.',
      'Proposed expense matches historical event budgets ($2,400 avg).',
      'Requires standard HR head approval due to threshold exceedance ($2,000 limit).',
      'Vendors have been pre-screened and registered.'
    ],
    aiRecommendation: 'Recommended: Approve. Within available departmental budget limits.',
    timeline: [
      { title: 'Submitted', date: '22 Aug 2025, 09:15 AM', user: 'Rahul Sharma', status: 'done' },
      { title: 'HR Review', date: 'Current Step', user: 'HR Manager (You)', status: 'current' },
      { title: 'Final Decision', date: 'Pending', user: '', status: 'pending' }
    ]
  },
  {
    id: 'REQ-2024-0612',
    ...
    priority: 'High',
    status: 'PENDING',
    dateRangeOrScope: 'Recruitment Software Subscription ($1,200/mo)',
    reason: 'Procurement of ATS subscription renewal to streamline bulk campus hiring process starting next month.',
    attachmentName: 'ATS_Software_Invoice.pdf',
    attachmentSize: '890 KB',
    aiPoints: [
      'License counts match active recruitment pipeline requirements.',
      'Subscription cost has increased by 4% compared to last year.',
      'Alternative software platforms are priced higher.'
    ],
    aiRecommendation: 'Recommended: Approve. Essential tool for scheduled college hiring campaigns.',
    timeline: [
      { title: 'Submitted', date: '21 Aug 2025, 04:30 PM', user: 'Priya Nair', status: 'done' },
      { title: 'HR Review', date: 'Current Step', user: 'HR Manager (You)', status: 'current' },
      { title: 'Final Decision', date: 'Pending', user: '', status: 'pending' }
    ]
  },
  {
    ...
    priority: 'Low',
    status: 'PENDING',
    dateRangeOrScope: 'Work From Home Extension (2 Weeks)',
    reason: 'Requesting a short temporary shift to remote structure due to renovation work at residence.',
    aiPoints: [
      'Employee performance record is exemplary (Grade A).',
      'No critical team dependencies require physically co-located work for this period.',
      'Secure corporate VPN configuration active.'
    ],
    aiRecommendation: 'Recommended: Approve. Short duration request with minimal business disruption.',
    timeline: [
      { title: 'Submitted', date: '21 Aug 2025, 02:00 PM', user: 'Arjun Mehta', status: 'done' },
      { title: 'HR Review', date: 'Current Step', user: 'HR Manager (You)', status: 'current' },
      { title: 'Final Decision', date: 'Pending', user: '', status: 'pending' }
    ]
  },
  {
    ...
    category: 'Policy',
    requester: 'Adon Sharrifa',
    department: 'HR Department',
    designation: 'HR Lead Specialist',
    priority: 'High',
    status: 'PENDING',
    dateRangeOrScope: 'Remote Work Policy Update 2025',
    reason: 'Proposed amendment draft for travel allowances and daily remote connectivity stipend regulations.',
    attachmentName: 'Stipend_Policy_Draft_2025.pdf',
    attachmentSize: '4.1 MB',
    aiPoints: [
      'Aligned with current compliance guidelines.',
      'Includes updated mileage reimbursement values ($0.65/mile).',
      'Estimated total budget increase across company is $12,400 annually.'
    ],
    aiRecommendation: 'Recommended: Review & Adjust. Requires approval of Board of Directors due to budget impact.',
    timeline: [
      { title: 'Submitted', date: '20 Aug 2025, 11:20 AM', user: 'Adon Sharrifa', status: 'done' },
      { title: 'HR Review', date: 'Current Step', user: 'HR Manager (You)', status: 'current' },
      { title: 'Final Decision', date: 'Pending', user: '', status: 'pending' }
    ]
  }
